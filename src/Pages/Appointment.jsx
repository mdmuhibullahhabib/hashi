      ...
      <div className="max-w-7xl mx-auto px-4 py-10 font-sans">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
          {services.map((service, index) => (
            <div
              key={index}
              className={`bg-white rounded-xl p-5 shadow hover:shadow-md transition cursor-pointer text-center ${
                selectedService?.name === service.name ? 'border-2 border-pink-500' : ''
              }`}
